...
import { normalizeRole, roleLabel, type Role } from "@/lib/permissions";
...
// Role model and role parsing live in lib/permissions (the single source of
// truth). Re-exported here so existing imports from "@/lib/auth" keep working.
export { normalizeRole, roleLabel, type Role };
