...
import { listAuditLogs, listAuditFacets } from "@/lib/audit";
import { selectAll } from "@/lib/supabase";
import { AuditFilters } from "@/components/analytics/AuditFilters";
...
function pageHref(sp: SP, page: number): string {
  ...
  for (const k of ["q", "entity", "action", "actor", "from", "to"] as const) {
...
export default async function AuditLogsPage({
  ...
  const [{ items, total }, facets, actors] = await Promise.all([
    listAuditLogs({
      q: searchParams.q,
